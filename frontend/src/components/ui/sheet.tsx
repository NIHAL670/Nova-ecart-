...
const sheetVariants = cva('fixed z-50 flex flex-col gap-4 bg-background shadow-raised transition-transform ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500', {
  variants: {
    side: {
